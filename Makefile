...
KERNEL_SRCS =  ./kernelInit.c ./pageMan.c ./trapHandlers.c ./kernelCalls.c ./common.c ./loadProg.c ./map.c
...
KERNEL_INCS = ./pageMan.h ./include/hardware.h ./include/yalnix.h ./trapHandlers.h ./common.h ./map.h
