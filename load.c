       ...
       */
{
  ...
  data_npg = li.id_npg + li.ud_npg;
	proc->DataPageStart = data_pg1;
	proc->NumberDataPages = data_npg;
  /*
...
==>> of the new process.
*/
	struct pte * ptable = proc->cow.pageTable;
